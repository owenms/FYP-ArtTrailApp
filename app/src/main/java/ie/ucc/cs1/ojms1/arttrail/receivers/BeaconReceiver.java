...
/**
 * Start the service to monitor beacon regions whenever bluetooth is turned on and
 * stop the service when bluetooth is turning off.
 */
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(BluetoothAdapter.ACTION_STATE_CHANGED.equals(action)){
            ...
            if(state == BluetoothAdapter.STATE_TURNING_OFF) {
                ...
                Log.d("BROADCAST_RECEIVER", "BeaconReceiver started");
